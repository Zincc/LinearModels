---
title: "Jednokierunkowa analiza wariancji"
...
```{r, warning=FALSE, message=FALSE}
pairwise.t.test(change.2191, Mutation, data=AML)

model.va.3 = aov(change.2191~Mutation, data=AML)
TukeyHSD(model.va.3)
...
SNK.test(model, "Mutation", console = TRUE)


LSD.test(model, "Mutation", p.adj="bonferroni", console = TRUE)
```
